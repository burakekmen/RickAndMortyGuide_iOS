...
// TODO:LATER -> daha sonra child coordinators logic'i eklenebilir.
...
class NavigationCoordinator: NSObject, Coordinator {
    ...
    init(navigationController: UINavigationController, hidesBar: Bool = false) {
        self.navigationController = navigationController
        self.navigationController.setNavigationBarHidden(hidesBar, animated: false)
    }
