...
extension UIView {
    ...
    func snp_setEdgesSuperViewConstraint() {
        snp.makeConstraints { (maker) in
            maker.edges.equalToSuperview()
        }
    }

    func updateSnpWidthConstraint(width: CGFloat) {
        snp.updateConstraints { (maker) in
            maker.width.equalTo(width)
        }
    }

    func makeSnpHeightConstraint(height: CGFloat) {
        snp.makeConstraints { (maker) in
            maker.height.equalTo(height)
        }
    }

    func makeSnpWidthConstraint(width: CGFloat) {
        snp.makeConstraints { (maker) in
            maker.width.equalTo(width)
        }
    }

    func updateSnpHeightConstraint(height: CGFloat) {
        snp.updateConstraints { (maker) in
            maker.height.equalTo(height)
        }
    }

    func updateSnpHeightGreaterThanConstraint(height: CGFloat) {
        snp.updateConstraints { (maker) in
