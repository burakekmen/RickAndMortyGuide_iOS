...
class CountryPickerViewController: UIViewController {
    ...
    deinit {
        print("killed: CountryPickerViewController")
    }
...
extension CountryPickerViewController {
    ...
    func showPicker(selectedCountry: String?) {
        guard let currentViewController = WindowHelper.getWindow()?.topMostViewController() else { return }
        DispatchQueue.delay(250) { [unowned self] in
            self.selectedCountry = selectedCountry ?? "TR"
